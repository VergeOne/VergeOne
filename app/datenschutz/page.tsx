...
export default function Datenschutz() {
  return (
    <div>
      <h2 className="">Datenschutzerklärung</h2>
      <p>
      ...
      Haßfurt
      <p>
        Telefon: 017683419242
        <br />
        Telefax: [Faxnummer]
        <br />
        E-Mail: info@verge-one.com
      </p>
      ...
      <br />
      E-Mail: [DSB – E-Mail] [nachfolgende Angaben sind zu ergänzen, sofern ein
      Externer Datenschutzbeauftragter bestellt ist] [DSB-Extern – Straße,
      Hausnummer]
      <br />
      ...
      <h4 className="jet-listing-dynamic-field__content">Instagram</h4>
      <p>
      ...
      <p>
        ...
        Ireland Ltd. auch über die Meta Platforms, Inc., 1601 Willow Road, Menlo
